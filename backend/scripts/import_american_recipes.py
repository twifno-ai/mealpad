#!/usr/bin/env python3
"""导入美式 seed JSON。同名则更新 description、ingredients、cuisine，否则插入。"""
...
from app.services.american_recipes_seed import ImportResult, import_american_recipes


def main() -> int:
    init_db()
    with Session(engine) as session:
        result: ImportResult = import_american_recipes(session)
    print(
