#!/usr/bin/env python3
"""导入法餐 seed JSON。同名则更新 description、ingredients、cuisine，否则插入。"""
...
from app.services.french_recipes_seed import ImportResult, import_french_recipes


def main() -> int:
    init_db()
    with Session(engine) as session:
        result: ImportResult = import_french_recipes(session)
    print(
